...
export type VeilOperation = "register_viewing_key" | "deposit" | "create_open_note" | "invoke" | "private_transfer" | "withdraw" | "forced_transfer" | "post_order" | "cancel_order" | "execute_batch" | "venue_fill" | "approve_private_transfer" | "private_transfer_as_approved" | "revoke_private_approval" | (string & {});
